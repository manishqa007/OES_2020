...
<body>
	...
	<div id="containerOne">
		...
		<div id="adminContent">
			<div id="menu">
				<p>MODIFY CATEGORY > Update Category > java</p>
				<a
					href="Check_Admin_Session_ModifyCategory_UpdateCategory_Java_ModifyQuestion.Admin_Filter?category=<%=category%>"><button
						id="modifyQuestion">Modify Question</button></a> <a
					href="Check_Admin_Session_ModifyCategory_UpdateCategory_Java_ModifySet.Admin_Filter?category=<%=category%>"><button
						id="addSet">Modify Set</button></a> <a
					href="Check_Admin_Session_ModifyCategory_UpdateCategory_Java_ModifyTopic.Admin_Filter?category=<%=category%>"><button
						id="addTopic">Modify Topic</button></a>
			</div>
		</div>
	</div>
