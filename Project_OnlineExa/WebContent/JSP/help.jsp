	...
	<div id="centerContent">
		<div id="ques1">
			...
			<p>There are two way to start, if you are a registered user then
				login directly from the Home page or use Login button from the Menu
				Bar. And if you are not a register user then click on hyperlink
		...
		<div id="ques2">
			...
			<br>
			<br>
			<p>Think Exam the online exam software will save the calculated
		...
		<div id="ques4">
			...
			<br>
			<br>
			<p>No. Think Exam the Online Assessment Software does not require
