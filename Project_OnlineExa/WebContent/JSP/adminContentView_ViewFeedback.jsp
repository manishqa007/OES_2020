...
<link rel="stylesheet" type="text/css"
	href="${pageContext.request.contextPath}/CSS/adminContentViewFeedback.css">
<link rel="icon"
...
<body>
	...
	<div id="containerOne">
		...
		<%
				...
				if(sess!=null)
				{
					Map<String,ArrayList<String>> feedbackMap=new LinkedHashMap<String,ArrayList<String>>();
					feedbackMap=(LinkedHashMap<String,ArrayList<String>>)sess.getAttribute("feedbackMap");
				...
				<div id="tableDiv">
					...
					%>
						<tr>
							...
							<th><%= key %></th>
							<th><%= feedbackList.get(0) %></th>
							<th><%= feedbackList.get(1) %></th>
							<th><%= feedbackList.get(2) %></th>
