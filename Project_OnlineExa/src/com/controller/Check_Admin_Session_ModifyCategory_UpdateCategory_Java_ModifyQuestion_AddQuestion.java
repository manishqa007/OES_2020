...
public class Check_Admin_Session_ModifyCategory_UpdateCategory_Java_ModifyQuestion_AddQuestion extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if(sess!=null)
		{
			...
			RequestDispatcher rd=getServletContext().getRequestDispatcher("/JSP/adminCategoryModifyUpdateCategoryJava_ModifyQuestion_AddQuestion.jsp");
